...
if __name__ == "__main__":
    ...
    try:
        ...
        # Compatability
        forms_win.config(bg=forms_win.style.lookup("TFrame", "background"))
        login_win.config(bg=login_win.style.lookup("TFrame", "background"))
        font.nametofont("TkDefaultFont").config(family="DejaVu Sans", size=10)
        font.nametofont("TkTextFont").config(family="DejaVu Sans", size=10)
        font.nametofont("TkFixedFont").config(family="DejaVu Sans Mono",
                                              size=10)
        font.nametofont("TkHeadingFont").config(family="DejaVu Sans", size=10,
                                                weight="bold")
        font.nametofont("TkCaptionFont").config(family="DejaVu Sans", size=12,
                                                weight="bold")
        font.nametofont("TkSmallCaptionFont").config(family="DejaVu Sans",
                                                     size=9)
        ##
        forms_win.withdraw()
        forms_win.mainloop()
